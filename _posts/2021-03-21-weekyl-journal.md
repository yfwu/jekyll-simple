...
週一買了思考已久的 Airpods Max。主要入手的原因除了音質之外，還是不喜歡在多個設備之間切來切去。跟舊的 Sony XM2 比起來，降噪有時候會不太穩定。高音部分音質樂勝，低音部分打平。總結來說，不用一直在我不同的 Apple 設備之間重新建立藍牙連結還蠻爽的。唯一的不快樂的點是需要額外買一條線才能從 3.5 mm 的輸出設備接到耳機。

## PS5

本週的高額購物除了 Airpods Max 還有 PS5。本來在地下街要買景品，意外聽到有綑光碟片的實體機現貨。去看了一下綁的光碟片，其實大部分是本來就想玩（只是本來只打算收二手的...）。既然有就順便買下來了。剛好可以用新機來打新櫻花大戰的四週目。4K 60 幀率的大絕超爽！我之前 PS4 Pro 好像沒有辦法上到真 4K，而是 1080P 放大兩倍。
